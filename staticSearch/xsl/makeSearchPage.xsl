        ...
        <xsl:copy>
            ...
            <div class="col-lg-3 left-column pl-0 pr-5">
                <div class="container de" id="input-search">
                    ...
                    <!--Now create the form-->
                    <form 
                        accept-charset="UTF-8" id="ssForm"
                        ...
                        <span class="ssQueryAndButton">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 mb-3">                            
                                    <input type="text" class="form-control" id="ssQuery" placeholder="Begriff hier eingeben" aria-label="{hcmc:getCaption('ssDoSearch', $captionLang)}"/>
                                </div>
                            </div>
                            
                            <div class="form-group row">
                                <div class="col-12">
                                    <button name="submit" type="submit" class="btn btn-primary" id="ssDoSearch">Absenden</button>
                                    <!--  <button name="submit" type="submit" class="btn btn-primary" id="ssDoSearch"><xsl:sequence select="hcmc:getCaption('ssDoSearch', $captionLang)"/></button> -->
                                </div>
                            </div>
          ...
          <xsl:if test="not(empty($filterJSONURIs[matches(.,'ssFeat\d+.*\.json')]))">
            ...
            <div class="col-lg-9 right-column pl-5 pr-0">
                <div class="container de" id="result-search">
                    <h2>Treffer:</h2>
                    ...
                    <table class="table metadaten">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Feld mit Auszug</th>
                            </tr>
                        </thead>
                        <tbody>
